...
public class NoteOperationsTest {
    ...
    void testCreateNewNote() {
        ...
        String noteTitle = "learn Python";
        String noteDescription = "python so ez";
    ...
    void testReadNotes() {
        ...
        List<WebElement> noteRows = driver.findElements(By.className("note-row"));

        assertNotNull(noteRows);
    ...
    void testEditNote() {
        ...
        String noteDescription = "update note description";
